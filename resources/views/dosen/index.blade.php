    ...
    <div class="row text-center">
        <div class="col-md-12">
            <div class="col-md-6 col-md-offset-3" style="padding-bottom: 20px;">
                ...
                <div class="col-md-6">
                    <a href="/dosen" style="color:black">
                        <h3>List Proyek</h3>
                    </a>
                </div>
                <div class="col-md-6">
                    <a href="/tentangdosen"style="color:black">
                        <h3>Tentang</h3>
                    </a>
                </div>
            </div>
...
<div class="row text-center" style="background-color:#F2F3F5;margin-left:-20px;">
    <img src="{{asset('asset/proyek1.png')}}" alt="logo" loading="lazy" style="padding-bottom: 20px;padding-top:20px;">
    <img src="{{asset('asset/proyek1.png')}}" alt="logo" loading="lazy" style="padding-bottom: 20px;padding-top:20px;">
</div>
@endsection